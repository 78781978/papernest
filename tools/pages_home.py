  ...
  <div class="container">
    {reveal(f'''<div class="cta-banner">
      ...
      <div class="cta-actions">
        <a href="sklep.html" class="btn" style="background:#fff;color:#4f7309;box-shadow:0 14px 30px rgba(0,0,0,.35)">Przejdź do sklepu</a>
...
"""
    page(
        ...
        "PaperNest produkuje wyroby z papieru: wypełniacze papierowe, tekturę budowlaną i papier dla piskląt. Oferujemy przewijanie i cięcie papieru.",
        "index.html",
        content,
    )
